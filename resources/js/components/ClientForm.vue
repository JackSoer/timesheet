<template>
  <PrimaryForm title="Add Client">
    <PrimaryInput
      label="Name"
      :inputProps="{ autofocus: true, required: true, placeholder: 'Jack' }"
    ...
    <PrimaryInput
      ...
      :inputProps="{ placeholder: '99999.99' }"
...
const { defaultClient, handleSubmit } = defineProps({
  defaultClient: {
    type: Object,
    default: {
      name: "",
